...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.window.rootViewController = computititonNavigation;
    //Override point for customization after application launch.
    BNRViewController *computitionViewController = [[BNRViewController alloc]init];
    //NSBundle *appBundle = [NSBundle mainBundle];
    /*BNRCalculatorViewController *calculatorViewController = [[BNRCalculatorViewController alloc]init];
    
    self.window.rootViewController = calculatorViewController;*/
    
    UIImageView *backgroundImageView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"back.png"]];
